...
@Component({
    selector: 'tc-expandable-text-example',
    template: require('./expandable-text.component.example.html')
})
export class ExpandableTextComponentExample
{
    protected loremIpsum:string = 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut ' +
    ...
    protected shortText:string = 'This is a short text. Ellipsis and "more" button should not be visible';
}

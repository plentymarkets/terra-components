...
export class TerraPagerComponent implements OnInit, OnDestroy {
    ...
    @Output()
    public readonly outputDoPaging: EventEmitter<TerraPagerInterface<unknown>> = new EventEmitter<
        TerraPagerInterface<unknown>
    >();
    ...
    public ngOnInit(): void {
        this._pagingClicks
            ...
            .subscribe((e: TerraPagerInterface<unknown>) => this.outputDoPaging.emit(e));

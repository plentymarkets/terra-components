...
describe(`RadioGroupComponent:`, () => {
  ...
  describe(`within a test host with radio inputs`, () => {
    ...
    it(`should update [checked] attribute of the corresponding input if #value is updated`, () => {
      let inputElement: HTMLInputElement = fixture.debugElement.queryAll(
    ...
    it(`should update the group's #value if a radio input is clicked`, () => {
      let inputElement0: HTMLInputElement = fixture.debugElement.queryAll(
        By.css('input[type="radio"]')
      )[0].nativeElement;
      let inputElement1: HTMLInputElement = fixture.debugElement.queryAll(
        By.css('input[type="radio"]')
      )[1].nativeElement;

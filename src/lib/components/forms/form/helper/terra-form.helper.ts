...
export class TerraFormHelper {
   ...
   * @param formField
   */
  public static generateFormArrayValidators(
   ...
   * @param values
   */
  public static parseReactiveForm(
    ...
    Object.keys(formFields).forEach((formFieldKey: string) => {
      ...
      if (formField.isList) {
        ...
        controls[formFieldKey] = new FormArray(
          formControls,
          this.generateFormArrayValidators(formField)
        );
   ...
   * @param formField
   */
  public static createNewControl(
    value: any,
    formField: TerraFormFieldInterface
   ...
   * @param controls
   */
  private static _fitControlsToRange(
    formField: TerraFormFieldInterface,

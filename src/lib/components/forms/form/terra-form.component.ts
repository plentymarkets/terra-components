...
export class TerraFormComponent implements ControlValueAccessor, OnChanges, OnInit {
   ...
   */
  @Input()
  public set inputFormFields(
    fields: { [key: string]: TerraFormFieldInterface } | Array<TerraFormFieldBase<any>>
  ) {
  ...
  public ngOnChanges(changes: SimpleChanges): void {
    if (
      changes.hasOwnProperty('inputControlTypeMap') &&
      !isNullOrUndefined(this.inputControlTypeMap)
    ) {

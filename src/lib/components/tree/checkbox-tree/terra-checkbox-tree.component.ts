...
export class TerraCheckboxTreeComponent extends TerraBaseTreeComponent
   ...
   */
  @Output()
  public valueChange: EventEmitter<TerraCheckboxLeafInterface> = new EventEmitter<
    TerraCheckboxLeafInterface
  >();
  ...
  private _getParentLeafState(leaf: TerraCheckboxLeafInterface): TerraCheckboxTreeLeafState {
    ...
    for (let subLeaf of leaf.subLeafList) {
      parentLeafState.allChildrenAreChecked =
        subLeaf.checkboxChecked && parentLeafState.allChildrenAreChecked;
      parentLeafState.noChildrenAreChecked =
        !subLeaf.checkboxChecked && parentLeafState.noChildrenAreChecked;

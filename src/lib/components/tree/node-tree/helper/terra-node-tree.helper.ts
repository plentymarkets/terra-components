...
{
    public static recursiveFindNode<D>(nodeList:Array<TerraNodeInterface<D>>, nodeToFind:TerraNodeInterface<D>):TerraNodeInterface<D>
    {
    ...
    public static recursiveFindNodeById<D>(nodeList:Array<TerraNodeInterface<D>>, id:string | number):TerraNodeInterface<D>
    {
        let foundNode:TerraNodeInterface<D> = null;
    ...
    public static recursiveSetParentAndDefaultVisibility<D>(list:Array<TerraNodeInterface<D>>, parent?:TerraNodeInterface<D>):void
    {

...
import { TableSettingsComponent } from './table/table-column-settings/table-settings.component';
import { TableSettingsDialogComponent } from './table/table-column-settings/dialog/table-settings-dialog.component';

...
export class TerraNestedDataPickerComponent implements OnInit, AfterContentChecked, OnDestroy {
  ...
  constructor(
    protected _translation: TranslationService,
  ...
  private getNestedData(parentId: number | string): Observable<TerraPagerInterface<{}>> {
    let obs: Observable<TerraPagerInterface<{}>> = this.inputNestedService.requestNestedData(
      parentId
    );
  ...
  private getNestedDataByParentId(
    parentId: number | string
  ): () => Observable<TerraPagerInterface<{}>> {

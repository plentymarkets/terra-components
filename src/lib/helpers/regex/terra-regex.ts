...
export class TerraRegex
{
    ...
    public static MYSQL_DATE_TIMESTAMP:string = '^[0-9]{4}-(((0[13578]|(10|12))-(0[1-9]|[1-2][0-9]|3[0-1]))|' +
    ...
    public static PERCENTAGE:string = '^((100[\\.,][0]*)|100|[0-9]{0,2}|[0-9]{1,2}[\\.,][0-9]{0,3})$';
    ...
    public static PASSWORD_COMBINED:string = '[^a-zA-Z0-9äöüÄÖÜ@<\\(\\{\\[/=\\\\\\]\\}\\)>!\\?\\$%&#\\*\\-\\+\\.,;:_\\^\\|~]';
    public static IP_V4_OR_DOMAIN:string = '(^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}' +
    ...
    public static PLENTY_CMS_SYNTAX:string = '(\\{%[\\s]*(if|for))([\\s\\S]*)(\\{%[\\s]*(endif|endfor)[\\s]*%\\})';
